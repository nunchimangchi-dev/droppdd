...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  "workout-not-found": "The requested workout was not found.",
};

const SUCCESS_MESSAGES: Record<string, string> = {
  "created": "Workout successfully provisioned in catalog.",
  "updated": "Workout successfully updated.",
  "deleted": "Workout successfully deleted from catalog.",
};
...
export default async function AdminWorkoutsPage({
  ...
  // Load all workouts with their exercises
